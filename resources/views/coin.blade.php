@include('partials.header')
		          ...
		          <ul class="cd-hero-slider">
			          <li class="selected pane">
			          	<div class="contents text-center">
				          	<br>
			            	<h1 class="wow fadeInDown coin-title" data-wow-duration="1000ms" data-wow-delay="0.3s">{{$coin['name']}} <span class="coin-symbol">({{$coin['symbol']}})</span>
	    ...
	    <div class="container">
		    <div class="row wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="0.3s">
			    ...
			    <div class="col-12 justify-content-center card-container">
					...
					<div id="pot-max-price" class="card coin with-question" ref="pot-max-price" style="width: 18rem;">
					  <div class="card-body">
					...
					<div id="earning-multiple" class="card coin with-question" ref="earning-multiple" style="width: 18rem;">
					  <div class="card-body">
    ...
    <section class="distance section-overlay">
	    <div class="container justify-content-center text-center">
		    <div class="slider-overlay"></div>
			<div class="row wow fadeInUp col-12" data-wow-duration="1000ms" data-wow-delay="0.3s">
				
				<p class="section-subtitle slider-text wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Move the slider to compare {{$coin['name']}} against the coins with higher ranks.  This will tell you what {{$coin['name']}} would be worth if it was ranked at <code> n rank </code> in the market.  The default comparison is to Bitcoin at rank #1.</p>
			...
			<br><br>
			<p class="section-subtitle slider-text wow fadeIn" data-wow-duration="1000ms" data-wow-delay="0.3s">Want to know how much your potential return could be if you invest a certain dollar amount at the coin's current market price?  Enter your value in the <code> Investment Amount </code> block below and watch the magic of the Coinsbie Calculator.</p>
					    ...
					    <div class="col-12 justify-content-center card-container">
							...
							<div class="card coin with-question" ref="total-coins" style="width: 18rem;">
							  <div class="card-body">
							    ...
							    <p id="total_coins" class="card-text">0</p>
							    <span class="card-info lnr lnr-question-circle"></span>
							  </div>
							</div>
							...
							<div class="card coin with-question" ref="potential-earning" style="width: 18rem;">
							  <div class="card-body">
							    ...
							    <p id="potential_earnings" class="card-text">0</p>
							    <span class="card-info lnr lnr-question-circle"></span>
							  </div>
							</div>
					    </div>
